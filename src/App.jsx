...
import profileImage from './assets/profile-optimized/profile.webp'
...
export default function App() {
    ...
    function isProtectedTarget(target) {
      return (
        ...
        (
          ...
          target.closest('.galleryItem') ||
          target.closest('.aboutImageWrap') ||
          target.closest('.lightboxFrame')
        )
      )
    }
  ...
  const heroImage = activeProject?.isVideoProject
    ? activeProject?.cover || ''
    : activeProject?.gallery?.[0] || activeProject?.cover || ''
        ...
        <main id="top">
          <section className="hero">
            ...
            <div className="heroInner">
              ...
              >
                <p className="eyebrow">
                  3D Artist <span className="metaDot" aria-hidden="true">&bull;</span>{' '}
                  CGI Artist <span className="metaDot" aria-hidden="true">&bull;</span>{' '}
                  VR Developer
                </p>
              ...
              >
                ...
                <p className="panelMeta">
                  {getDisplayLabel(
                    ...
                    activeProject?.categoryLabel || 'Portfolio'
                  )}
